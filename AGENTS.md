...
| **PR35**  | `pr35-research`                                | Complete | Research contracts (branded IDs, provenance, bounds), SSRF/redirect/MIME guards, static web reader + Jina, Exa/GitHub/YouTube/RSS adapters, ResearchService + router + cache, ResearchToolExecutor (5 builtin tools), AgentRuntime routing, research:search/open IPC (no execute), ResearchSurface UI, 100+ tests |
